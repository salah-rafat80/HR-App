          ...
          builder: (context, state) {
            if (state is PayrollError) {
              return ErrorStateWidget(
                ...
                onRetry: () => context.read<PayrollCubit>().loadData(),
              );
            }
            ...
            return ListView(
              ...
              children: [
                if (state.bonusNotice != null)
                  Container(
                    ...
                    child: Text(
                      'bonus_notice'.tr(
                        namedArgs: {
                          'message': state.bonusNotice!.message,
                          'amount': currencyFormat.format(
                            state.bonusNotice!.amount,
                          ),
                        },
                      ),
                      style: TextStyle(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Text(
                              currencyFormat.format(
                                state.ytdSummary.totalEarnings,
                              ),
                              style: TextStyle(
                                fontSize: 14.sp,
                                fontWeight: FontWeight.bold,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              currencyFormat.format(
                                state.ytdSummary.totalDeductions,
                              ),
                              style: TextStyle(
                                fontSize: 14.sp,
                                fontWeight: FontWeight.bold,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              currencyFormat.format(state.ytdSummary.netYtd),
                              style: TextStyle(
                                fontSize: 16.sp,
                                fontWeight: FontWeight.bold,
                ...
                SizedBox(height: 16.h),
                ElevatedButton.icon(
                  onPressed: state.isDownloadingTax
                      ? null
                      : () => context
                            .read<PayrollCubit>()
                            .downloadTaxCertificate(),
                  icon: state.isDownloadingTax
                      ? const SizedBox(
                          width: 16,
                          height: 16,
                          child: AppLoader(size: 24),
                        )
                      : const Icon(AppIcons.payroll),
                  label: Text(
                    state.isDownloadingTax
                        ? 'downloading'.tr()
                        : 'download_tax_cert'.tr(),
                  ),
                ),
                ...
                ...state.payslips.map(
                  (p) => AppCard(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        currencyFormat.format(p.netPay),
                        style: TextStyle(
                          color: AppColors.primary,
                          fontWeight: FontWeight.bold,
                        ),
