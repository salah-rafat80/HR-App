      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _buildQuickLoginChip('Manager (IT)', 'TEST-MGR-002', 'HrTest!2026-N8', Colors.deepPurple),
              ...
              _buildQuickLoginChip('Manager (HR)', 'TEST-HRA-001', 'HrTest!2026-E8', Colors.red),
              _buildQuickLoginChip('TL (HR)', 'TEST-TL-003', 'HrTest!2026-O9', Colors.pinkAccent),
